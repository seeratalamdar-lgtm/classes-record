                ...
                onPress={async () => {
                  if (scheduleId) {
                    ...
                    if (typeof window !== "undefined") {
                      ...
                      typeof window !== "undefined" ? window.location.href : "" = url.toString();
                    }
                  }
                }}
